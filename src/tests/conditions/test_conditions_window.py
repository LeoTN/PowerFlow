...
def test_window_condition_matches_existing_window() -> None:
    provider = Dummy_WindowProvider(given_window_exists=True, given_is_available=True)
...
def test_window_condition_matches_missing_window() -> None:
    provider = Dummy_WindowProvider(given_window_exists=False, given_is_available=True)
